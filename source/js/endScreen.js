 ...
 */
export function createEndScreen(metrics) {
 ...
 */
export function renderEndScreen(container, metrics) {
  if (!(container instanceof HTMLElement)) {
    throw new Error('renderEndScreen expects an HTMLElement container.');
  }

  const endScreen = createEndScreen(metrics);
  container.innerHTML = '';
...
export function showEndScreen(container, roundData) {
  ...
  return renderEndScreen(container, metrics);
}