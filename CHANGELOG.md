...
- Architecture Decision Records (MADR format): ADR-001 (tech stack, accepted), ADR-002 (live render strategy, accepted), ADR-003 (deployment target, proposed stub awaiting content), ADR-004 (JSON prompt schema, proposed)
