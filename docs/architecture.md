...
Linting and automated style enforcement: Included in [testing.md](./testing.md). HTML and CSS files are also validated in CI via the proposed [ADR-008](decisions/008-html-css-validation.md).
